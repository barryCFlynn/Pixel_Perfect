...
class OrderLineItem(models.Model):
    ...
    inventory_item = models.ForeignKey(InventoryItem, null=False, blank=False, on_delete=models.CASCADE)
    ...
    def __str__(self):
        return f'SKU {self.InventoryItem.sku} on order {self.order.order_number}'